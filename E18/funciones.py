...
def leer_apikey(path="apikey.txt"):
    """
    Lee la API key desde un archivo local.
    Si no existe, solicita al usuario la clave y la guarda.
    """
...
def obtener_argumentos():
    """
    Obtiene los argumentos de la línea de comandos usando argparse.
    """
    ...
    parser.add_argument(
        ...
        "--output",
        default="reporte.csv",
        help="Nombre del archivo CSV de salida (por defecto: reporte.csv)"
    )
...
def consultar_brechas(correo, api_key):
    """
    Consulta las brechas en las que un correo aparece.
    """
...
def consultar_detalle(nombre, api_key):
    """
    Consulta los detalles de una brecha en específico.
    """
...
def generar_csv(nombre_archivo, lista_detalles):
    """
    Genera un archivo CSV con la información de las brechas.
    """
